...
//go:generate mockgen -destination=handler_mock/inbox_mock.go -package=handler_mock github.com/jesusnoseq/request-inbox/pkg/handler InboxController,HealthHandler,UtilityHandler
